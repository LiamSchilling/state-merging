...
def make_input_set() -> set[str]:
    """Return the set of all unique graphemes (input characters) in the CMU Dictionary.
    ...
    Returns:
        A set of all unique grapheme characters in the CMU Dictionary.
    """
    return {c for k in cmudict.dict() for c in k}


def make_output_set() -> set[str]:
    """Return the set of all unique phonemes (output characters) in the CMU Dictionary.
    ...
    Returns:
        A set of all unique phoneme characters in the CMU Dictionary.
    """
    return {c for _, v in cmudict.entries() for c in v}
